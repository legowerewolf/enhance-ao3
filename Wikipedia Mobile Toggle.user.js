...
// @version      0.3.2
// @updateURL    https://raw.githubusercontent.com/legowerewolf/Userscripts/main/Wikipedia%20Mobile%20Toggle.user.js
// @downloadURL  https://raw.githubusercontent.com/legowerewolf/Userscripts/main/Wikipedia%20Mobile%20Toggle.user.js
...
if (location.host == "en.m.wikipedia.org") {
	Array.from(
		document.querySelectorAll("h2.collapsible-heading:not(.open-block)")
	).forEach((element) => {
		element.click();
	});
}
